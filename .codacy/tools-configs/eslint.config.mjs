export default [
    {
        // Source files that use CommonJS (require, __dirname etc.)
        files: ["**/*.js", "**/*.jsx", "**/*.cjs", "**/*.vue"],
        languageOptions: {
          ecmaVersion: 2022,
          sourceType: "script",
          globals: {
            // Node.js globals for scripts (install.js, bin/nyx shim)
            console: "readonly",
            process: "readonly",
            require: "readonly",
            __dirname: "readonly",
