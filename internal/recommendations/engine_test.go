...
func TestGenerateRecommendations_VantagePointAggregation(t *testing.T) {
	...
	spec := &intent.Spec{
		Networks: []intent.Network{
			{Name: "trusted", CIDR: "10.0.0.0/24", Zone: "trusted"},
...
func TestRealAuditScenario(t *testing.T) {
	...
	spec := &intent.Spec{
		Networks: []intent.Network{
			{Name: "trusted", CIDR: "10.0.10.0/24", Zone: "trusted", Gateway: "10.0.10.1"},
			{Name: "personal", CIDR: "10.0.20.0/24", Zone: "personal", Gateway: "10.0.20.1"},
			{Name: "gaming", CIDR: "10.0.30.0/24", Zone: "gaming", Gateway: "10.0.30.1"},
			{Name: "iot", CIDR: "10.0.40.0/24", Zone: "iot", Gateway: "10.0.40.1"},
			{Name: "media", CIDR: "10.0.50.0/24", Zone: "media", Gateway: "10.0.50.1"},
		},
		VPN: []intent.VPNConfig{
			{Name: "primary-vpn", Type: "wireguard", Interface: "wg0"},
		},
