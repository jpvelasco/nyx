...
func Dir() (string, error) {
	...
	if err := os.MkdirAll(dir, 0700); err != nil { // nosemgrep // #nosec G301
...
func Save(specPath string, report *models.AuditReport) (string, error) {
	...
	if err := os.WriteFile(path, data, 0600); err != nil { // nosemgrep // #nosec G302
...
func SetBaseline(specPath string, report *models.AuditReport) error {
	...
	return os.WriteFile(baselPath, data, 0600) // nosemgrep // #nosec G302
}
...
func LoadBaseline() (*Snapshot, error) {
	...
	data, err := os.ReadFile(baselPath) // nosemgrep // #nosec G304
	if err != nil {
